...
(lib.brainIntro = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(165.1,452.6,0.341,0.341);
	...
	this.instance.setTransform(65.3,384.9,1,1,0,180,0,8.7,-36.7);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(19).to({_off:false},0).wait(1).to({regX:0,regY:0,skewX:174.5,skewY:-5.5,x:53.1,y:349.2},0).wait(1).to({skewX:169.2,skewY:-10.8,x:49.9,y:350.5},0).wait(1).to({skewX:164.1,skewY:-15.9,x:46.9,y:352},0).wait(1).to({skewX:159.2,skewY:-20.8,x:44.1,y:353.7},0).wait(1).to({skewX:154.5,skewY:-25.5,x:41.6,y:355.5},0).wait(1).to({skewX:150,skewY:-30,x:39.4,y:357.4},0).wait(1).to({skewX:145.7,skewY:-34.3,x:37.4,y:359.5},0).wait(1).to({skewX:141.6,skewY:-38.4,x:35.7,y:361.5},0).wait(1).to({skewX:138,skewY:-42,x:34.3,y:363.4},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({regX:8.6,regY:-36.6,scaleX:1,scaleY:1,skewX:138.1,skewY:-41.9,x:65.3,y:384.9},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,skewX:138,skewY:-42,x:34.4,y:363.4},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).to({_off:true},1).wait(70));

	// Calque 2
	this.instance_1 = new lib.leftArm("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(55.8,417.6);
	...
	this.shape_1.setTransform(135.5,453,0.341,0.341);
	...
	this.shape_2.setTransform(236.6,418.1,0.341,0.341);
	...
	this.shape_3.setTransform(140.3,359.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#30343D").s().p("");
	this.shape_4.setTransform(140.3,359.6);

	this.instance_2 = new lib.Symbole1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(140.1,359,1,1,0,0,0,34.4,8.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_3).to({_off:true},8).wait(4).to({_off:false,x:140.1,y:359},0).to({_off:true},7).wait(51).to({_off:false},0).to({_off:true},13).wait(3).to({_off:false,x:149.7},0).to({_off:true},18).wait(3).to({_off:false,x:136},0).wait(32).to({x:140.1},0).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(19).to({_off:false},0).wait(1).to({x:134.8,y:358.4},0).wait(1).to({x:129.6,y:357.8},0).wait(1).to({x:124.6,y:357.1},0).wait(1).to({x:119.7,y:356.6},0).wait(1).to({x:118.8,y:356.5},0).wait(45).to({_off:true},1).wait(70));
	...
	this.shape_5.setTransform(91.8,400.3,0.341,0.341);
	...
	this.shape_6.setTransform(119,405.5,0.341,0.341);
	...
	this.shape_7.setTransform(172.1,397.7,0.341,0.341);
	...
	this.shape_8.setTransform(139.2,373.3,0.341,0.341);
	...
	this.shape_9.setTransform(188.3,376.4,0.341,0.341);
	...
	this.shape_10.setTransform(134.5,321.5,0.341,0.341);
	...
	this.shape_11.setTransform(195.8,339.3,0.341,0.341);
	...
	this.shape_12.setTransform(188.9,333.5,0.341,0.341);
	...
	this.shape_13.setTransform(171.6,421.6,0.341,0.341);
	...
	this.shape_14.setTransform(164.9,420.7,0.341,0.341);
	...
	this.shape_15.setTransform(129.7,354.9,0.341,0.341);
	...
	this.shape_16.setTransform(129,348.2,0.341,0.341);
	...
	this.shape_17.setTransform(214.9,392.7,0.341,0.341);
	...
	this.shape_18.setTransform(218.3,382.9,0.341,0.341);
	...
	this.shape_19.setTransform(77.7,370.1,0.341,0.341);
	...
	this.shape_20.setTransform(72.9,378.4,0.341,0.341);
	...
	this.shape_21.setTransform(175.9,346.1,0.341,0.341);
	...
	this.shape_22.setTransform(223.6,366.3,0.341,0.341);
	...
	this.shape_23.setTransform(80.4,408.6,0.341,0.341);
	...
	this.shape_24.setTransform(78.3,346.7,0.341,0.341);
	...
	this.shape_25.setTransform(155.6,360.9,0.341,0.341);
	...
	this.shape_26.setTransform(100.4,384.8,0.341,0.341);
	...
	this.shape_27.setTransform(100.4,374.5,0.341,0.341);
	...
	this.shape_28.setTransform(100.7,358.5,0.341,0.341);
	...
	this.shape_29.setTransform(97.3,361.6,0.341,0.341);
	...
	this.shape_30.setTransform(176.2,324,0.341,0.341);
	...
	this.shape_31.setTransform(177.2,320.2,0.341,0.341);
	...
	this.shape_32.setTransform(137,392.7,0.341,0.341);
	...
	this.shape_33.setTransform(133.7,395.8,0.341,0.341);
	...
	this.shape_34.setTransform(195.7,349.2,0.341,0.341);
	...
	this.shape_35.setTransform(193.2,357.3,0.341,0.341);
	...
	this.shape_36.setTransform(139.9,421.8,0.341,0.341);
	...
	this.shape_37.setTransform(151,416.5,0.341,0.341);
	...
	this.shape_38.setTransform(106.7,354.6,0.341,0.341);
	...
	this.shape_39.setTransform(193.2,400.6,0.341,0.341);
	...
	this.shape_40.setTransform(152.4,346.1,0.341,0.341);
	...
	this.shape_41.setTransform(113.1,329.8,0.341,0.341);
	...
	this.shape_42.setTransform(145,368.8,0.341,0.341);
	...
	this.shape_43.setTransform(145,368.8,0.341,0.341);
...
p.nominalBounds = new cjs.Rectangle(197.2,546.5,200,173.5);
// library properties:
lib.properties = {
	width: 300,
	height: 480,
