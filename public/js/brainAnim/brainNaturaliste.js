...
if (reversed == null) { reversed = false; }
	...
	// Yeux
	this.instance = new lib.Yeux_fermé();
	this.instance.setTransform(320.85,242.5);
	...
	this.shape.setTransform(304.0727,241.3692);

	this.instance_1 = new lib.Yeux("synched",0);
	this.instance_1.setTransform(320.85,241.45);
	...
	this.shape_1.setTransform(322.8366,282.9185,0.0762,0.0762);
	...
	this.shape_2.setTransform(322.3413,273.564,0.0762,0.0762);
	...
	this.shape_3.setTransform(322.3413,275.7716,0.0762,0.0762);
	...
	this.shape_4.setTransform(322.6632,273.3767,0.0762,0.0762);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#9F1D2E").s().p("AAmNwQk0gFijgJQmPgWjKg0QpuiioWqpQkml4jWnIMBUVACIQkkIolZF6QoLI/o+BbQjZAjmhAAQiIAAidgEg");
	this.shape_5.setTransform(322.6632,279.1351,0.0762,0.0762);

	this.instance_2 = new lib.Yeux_fermé();
	this.instance_2.setTransform(322.4,278.6,0.0762,0.0762,0,0,0,0.7,0.7);

	this.instance_3 = new lib.Brain();
	this.instance_3.setTransform(322.4,279.25,0.0762,0.0762,0,0,0,0.7,0.7);
	...
	this.shape_6.setTransform(321.075,278.4958);
	...
	this.shape_7.setTransform(321.5244,271.5048,0.0742,0.0742);
	...
	this.shape_8.setTransform(322.4336,273.5589,0.0742,0.0742);
	...
	this.shape_9.setTransform(322.0959,279.6283,0.0742,0.0742);
	...
	this.shape_10.setTransform(322.3278,279.0348,0.0742,0.0742);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#9F1D2E").s().p("AqrlFQLCBQKVI7g");
	this.shape_11.setTransform(338.181,273.5185,0.0742,0.0742);
	...
	this.shape_12.setTransform(321.4261,271.7764,0.0742,0.0742);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#9F1D2E").s().p("AIylOIxjKdQICoqJhhzg");
	this.shape_13.setTransform(305.5729,273.7819,0.0742,0.0742);
	...
	this.instance_4.setTransform(245.5,264.5,1,1,0,0,0,10.7,27.7);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(185).to({_off:false},0).wait(6).to({regY:27.6,rotation:-150.0008,x:245.45,y:264.45},10).wait(39));

	// Bras_droite
	this.instance_5 = new lib.Bras_droite();
	this.instance_5.setTransform(409.9,236.8);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(185).to({_off:false},0).wait(6).to({regX:-9.7,regY:26.1,x:400.2,y:262.9},0).to({regY:26.2,rotation:-18.1698,x:400.25,y:263},4).to({rotation:10.7326,x:400.15,y:263.1},4).to({rotation:-18.1698,x:400.25,y:263},4).to({rotation:10.7326,x:400.15,y:263.1},4).to({rotation:-18.1698,x:400.25,y:263},4).to({rotation:10.7326,x:400.15,y:263.1},3).to({rotation:-18.1698,x:400.25,y:263},12).to({regX:-9.6,scaleX:0.9999,scaleY:0.9999,rotation:146.04,y:262.95},13).wait(1));
	...
	this.shape_14.setTransform(337.3998,328.7093);
	...
	this.shape_15.setTransform(302.5315,329.0129);
	...
	this.instance_6.setTransform(370.6,238.9,1,1,0,0,0,49.6,-13);

	this.instance_7 = new lib.Brain();
	this.instance_7.setTransform(320.85,250.95);
	...
	// Background
	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#BFAC97").s().p("AmlBeQivgnAAg3QAAg2CvgnQCvgnD2AAQD3AACvAnQCvAnAAA2QAAA3ivAnQivAnj3gBQj3ABiugng");
	this.shape_16.setTransform(318.825,356.3);
	this.shape_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_16).wait(174).to({_off:false},0).wait(66));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(507.4,413.2,-1.3999999999999773,-43.599999999999966);
// library properties:
lib.properties = {
